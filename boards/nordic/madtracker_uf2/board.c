...
static int board_madtracker_init(void)
{
	/* using vcc-gpios for sensor power defined in madtracker_uf2.dts
	 */
	...
	/* pull up on P0.13 for external 3V3 regulator
	 */
...
SYS_INIT(board_madtracker_init, PRE_KERNEL_1,
