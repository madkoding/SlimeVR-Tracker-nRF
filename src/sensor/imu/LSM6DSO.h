...
// Sensor Hub registers (LSM6DSO)
#define LSM6DSO_FUNC_CFG_ACCESS 0x01
#define LSM6DSO_SLV0_ADD 0x02
#define LSM6DSO_SLV0_SUBADD 0x03
#define LSM6DSO_SLV0_CONFIG 0x04
#define LSM6DSO_DATAWRITE_SLV0 0x0E
...
// External sensor functions for LSM6DSO
