...
int lsm_init(
	...
	if (spi_ret == 0) {
		LOG_INF("Using SPI interface for LSM6DSV sensor");
	} else {
		LOG_INF("SPI interface not available, using I2C interface for LSM6DSV sensor");
	}
...
uint8_t lsm_setup_WOM(void) {  // TODO: should be off by the time WOM will be setup
